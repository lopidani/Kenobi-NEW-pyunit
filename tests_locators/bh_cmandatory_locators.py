...
#edit_form_xpath="//a[text()='Edit Forms']"
shared_xpath="/html[1]/body[1]/div[1]/aside[1]/div[3]/div[1]/div[1]/div[2]/div[2]/div[1]/h5[1]"#"//h5[@class='collapsed']"
crossbr_test_xpath="//a[contains(@title,'Cross Browser Testing')]"
beh_integr_xpath="//a[contains(@title,'Behaviour Integration')]"
beh_form_cmandatory_xpath="//a[@title='TC_Beh_Integration_Form_CMandatory']"
...
# era  
#txtctrl_xpath="//div[@id='PFXX6488415142554894336']//div[@name='text']"
txtctrl_xpath="//div[@id='PFXX6488415142554894336']"
...
#-----------------------------------
# SCREENSHOTS NAMES
if sys.platform=="win32":canvas_img="\\canvas.png"
elif sys.platform=="darwin":canvas_img="/canvas.png"
#-----------------------------------
...
def get_elements(browser):
    if 'desktop' in browser:
       ...
       "source_tool":"selenium","source_click":1,"source_check":0,"source_change":0},
       {"source":"btn","source_name":"Shared","source_locator_type":"xpath","source_locator_string":shared_xpath,\
       "source_tool":"selenium","source_click":1,"source_check":0,"source_change":0},
       {"source":"btn","source_name":"CrossBrowser Testing","source_locator_type":"xpath","source_locator_string":crossbr_test_xpath,\
       "source_tool":"selenium","source_click":1,"source_check":0,"source_change":0},
       {"source":"btn","source_name":"Behavior Integration","source_locator_type":"xpath","source_locator_string":beh_integr_xpath,\
       "source_tool":"selenium","source_click":1,"source_check":0,"source_change":0}, 
       {"source":"btn","source_name":"CMandatory behavior","source_locator_type":"xpath","source_locator_string":beh_form_cmandatory_xpath,\
       "source_tool":"selenium","source_click":1,"source_check":0,"source_change":0}, 
                ]
       ...
       Ecnv_img=[
       {"source":"canvas","source_name":'CMandatory canvas',"source_locator_type":"xpath","source_locator_string":canvas_xpath,\
       "source_tool":"selenium","source_click":0,"source_check":0,"source_change":0,"screenshot":1,"source_img_name":canvas_img},
                ] 
       ...
       # else last published version (wihout click first published version) 
       else:E=[Elog,Egreet,Ehlp,Ech_form,Ecnv_entr,Ecnv_img,Ecnv_elem1,Ecnv_elem2] 
    return E   